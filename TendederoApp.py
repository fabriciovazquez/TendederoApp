...
st.markdown("""
    ...
    /* 🟢 EL BOTÓN FLOTANTE DEL MICRÓFONO (Se mantiene idéntico, verde e impecable) */
...
# 🎙️ VENTANA EMERGENTE DE DICTADO POR VOZ (Estilo Caja de Diálogo)
...
# 3. 🟢🟡🔴 FEED VISUAL TIPO SEMÁFORO: ALERTAS DE CADUCIDAD
